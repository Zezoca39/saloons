...
const Confirmacao = ({ onBack }) => {
    ...
    return (
        <div className="container-confirmacao">
            ...
            <nav className="nav-confirmacao">
                Responsável &gt; Informações Gerais &gt; Equipe &gt; Preços &gt; Horário &gt; Métodos de Pagamento &gt; Redes Sociais &gt; <span>Confirmação</span>
            </nav>
            <div className="secao-confirmacao">
                <h4>9.1 - Informações Pessoais</h4>
                <p>{dados.pessoal.nome} ( {dados.pessoal.email} | {dados.pessoal.telefone} )</p>
            </div>
            <div className="secao-confirmacao">
                <h4>9.2 - Informações Gerais</h4>
            ...
            <div className="secao-confirmacao">
                ...
                <ul>
                    {dados.equipe.map((membro, index) => (
                        <div key={index} className="secao-equipa">
            ...
            <div className="secao-confirmacao">
                <h4>9.6 - Métodos de Pagamento</h4>
            ...
            <div className="secao-confirmacao">
                <h4>9.8 - Redes Sociais</h4>
                <div className="redes-sociais-confirmacao">
            ...
            <div className="button-confirmacao-container">
                <button className="button-confirmacao" onClick={onBack}>Voltar</button>
                <button className="button-confirmacao" onClick={() => {
